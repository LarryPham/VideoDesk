...
abstract class ScrollViewScrollDetector implements ObservableScrollView.OnScrollChangedListener {
    ...
    @Override
    public void onScrollChanged(ScrollView who, int left, int top, int oldLeft, int oldTop) {
        boolean isSignificantDelta = Math.abs(top - mLastScrollY) > mScrollThreshold ;
