...
public class MovieMediaItem {
    // The unique id of the Video MediaItem
   /* private final String mUniqueId;
    ...
    private final long mDurationMilliseconds;

    private final long mBeginBoundaryTimeMilliseconds;
    private final long mEndBoundaryTimeMilliseconds;*/
